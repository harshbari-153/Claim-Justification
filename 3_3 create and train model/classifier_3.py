...
################## Constants ####################
MODEL_NAME = "classifier_3"
path_1 = "..\\2_1 generate sentiments\\embeddings_"
path_2 = "..\\2_2 generate embeddings\\embeddings_"
d1 = 21
d2 = 768
#################################################
...
def get_labels(labels):
  ...
  label_mapping = {"true": 2, "mostly-true": 2, "half-true": 2, "mostly-false": 0, "false": 0, "pants-fire": 1}
...
model.fit(x_train, y_train, validation_data = (x_test, y_test), epochs = 20, batch_size = 64, class_weight=class_weight_dict, callbacks=[early_stopping])
